...
const CollectionCard = ({ collectionName, bookCount, viewMode = 'grid' }: CollectionCardProps) => {
                    ...
                    <div className={`relative z-10 flex-1 w-full text-left`}>
                        <div className="flex flex-col items-start justify-center gap-2">
                            ...
                            <div className="flex items-center gap-1.5 bg-stone/60 px-2 py-0.5 rounded-2xl">
                                <Library size={11} className="opacity-70" />
                                <span className="font-bold text-xs font-sans text-dark-grey/60">{bookCount}</span>
                            </div>
                        </div>
                    </div>
                )}
