...
import SearchModal from "@/components/chrome/dashboard/SearchModal";
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed bottom-5 z-20 left-1/2 -translate-x-1/2 flex items-center justify-center">
      ...
      <AnimatePresence>
        {isSearchOpen && <SearchModal isSearchOpen={isSearchOpen} setIsSearchOpen={setIsSearchOpen} />}
      </AnimatePresence>
    </>
  );
};
